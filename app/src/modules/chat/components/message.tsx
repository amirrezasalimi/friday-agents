                        ...
                        <div className="flex gap-2 w-full">
                            {message.meta?.outputType === 'view' ? (
                                <div className="flex flex-col gap-2 w-full">
                                    ...
                                    {
                                        message.content && (
                                            <p className="text-md w-fit max-w-[80%] flex flex-col rounded-md p-2 bg-[#27272A] text-white overflow-scroll">
                                                <MessageContent content={message.content} />
                                            </p>
                                        )}
                                </div>
                            ) : (
                                <p className="text-md flex flex-col gap-2 rounded-md p-2 bg-[#27272A] text-white overflow-scroll">
