...
export const MessageList = memo(forwardRef<{ scrollToBottom: () => void }, MessageListProps>(
    ...
    return (
        ...
        >
            ...
            {showScrollButton && (
                <div className="sticky bottom-2 sm:bottom-0 flex justify-center px-2 sm:px-4 opacity-70">
                    <Button
